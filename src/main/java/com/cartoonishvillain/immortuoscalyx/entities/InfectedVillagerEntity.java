...
public class InfectedVillagerEntity extends Monster implements InfectedEntity {
    ...
    public static final Predicate<LivingEntity> ATTACKPREDICATE = (Target) ->{
        ...
        return h.getInfectionProgress() <= 0;
    };
    ...
    @Override
    protected SoundEvent getAmbientSound() { return Register.VILIDLE; }

    @Override
    protected SoundEvent getDeathSound() {return Register.VILDEATH; }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) { return Register.VILHURT; }
